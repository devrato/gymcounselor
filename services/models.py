...
class Service(models.Model):
    ...
    test1 = models.CharField(max_length=120, blank=True, null=True)
    test2 = models.CharField(max_length=120, blank=True, null=True)
    test3 = models.CharField(max_length=120, blank=True, null=True)
    feat = models.CharField(max_length=120, blank=True, null=True)
